...
import {
  ...
  AssignmentTurnedIn as WorkoutIcon,
  LocalDining as MealPlanIcon,
  AddTask as AddPlanIcon
...
const menuItems = [
  ...
  },
  {
    ...
    description: 'Build New Programme'
  },
  {
    title: 'Meal Plans',
    icon: <MealPlanIcon />,
    path: '/admin/meal-plans',
    description: 'Assigned Nutrition Plans'
  },
  {
    title: 'Create Meal Plan',
    icon: <AddPlanIcon />,
    path: '/admin/meal-plans/create',
    description: 'Build New Meal Plan'
  },
  {
    title: 'Appointments',
...
import {
  ...
  AssignmentTurnedIn as WorkoutIcon,
  AddTask as AddPlanIcon,
  AssignmentTurnedIn as WorkoutPlanIcon,
...
const menuItems = [
  ...
  },
  {
    ...
    path: '/admin/workout-plans/create',
    description: 'Assign training programmes'
  },
  {
    title: 'Meal Plans',
    icon: <MealPlanIcon />,
    path: '/admin/meal-plans/create',
    description: 'Personalised nutrition plans'
  },
  {
    title: 'Appointments',
    icon: <AppointmentIcon />,
