...
function AppointmentManagement() {
  ...
  const processChartData = (bookingList) => {
    ...
    bookingList.forEach((b) => {
      // ✅ FIX: Use appointment date instead of createdAt
  ...
  const handleDownloadPdf = () => {
    ...
    doc.setFontSize(14);
    doc.setTextColor(60);
    doc.text('Appointments in Last 6 Months', 14, sectionHeaderY);

    const tableColumn = ['Trainer', 'Time Slot', 'Client', 'Contact', 'Status', 'Appointment Date'];
    ...
    const filteredLast6Months = bookings.filter((b) => {
      ...
      return appointmentDate >= new Date(sixMonthsAgo.getFullYear(), sixMonthsAgo.getMonth(), 1);
    });
    ...
    const tableRows = filteredLast6Months.map((b) => {
      ...
      return [
        ...
        appointmentDate, // ✅ Now shows actual appointment date
      ];
    });
              ...
              <TableBody>
                {loading ? (
                  ...
                  filteredBookings.map((booking) => {
                    ...
                    // ✅ FIX: Use appointment date with proper formatting
                    const appointmentDate = formatAppointmentDate(booking.date);
                    ...
                    return (
                      <TableRow key={booking._id} hover>
                        ...
                        <TableCell>
                          ...
                          {booking.clientContact?.email || 'No contact info'}
                        </TableCell>
                        <TableCell>
                          <Select
